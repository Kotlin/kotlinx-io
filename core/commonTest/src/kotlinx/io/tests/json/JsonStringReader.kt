...
package kotlinx.io.tests.json

import kotlinx.io.tests.json.EscapeCharMappings.ESCAPE_2_CHAR
import kotlin.jvm.*
...
public class JsonParsingException(position: Int, message: String) : Exception("Invalid JSON at $position: $message")
